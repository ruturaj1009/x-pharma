    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (data.success) {
                ...
                // Redirect to the new Test View page or the list
                // Since we need to add subtests for groups, maybe redirect to View page?
                // For now, let's redirect to the list. 
                // Wait, if it's a group, the user needs to add subtests.
                // Redirecting to View Page makes sense.
                ...
                <div>
                    ...
                    <div style={{ display: 'flex', gap: '20px', marginBottom: '30px' }}>
                        <div style={{ flex: 1 }}>
                            ...
                            <input type="text" value={method} onChange={e => setMethod(e.target.value)} style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid #cbd5e1' }} />
                        </div>
                        <div style={{ flex: 1 }}>
                           <label style={{ display: 'block', marginBottom: '6px', fontSize: '13px', color: '#64748b' }}>Formula</label>
                           <input type="text" value={formula} onChange={e => setFormula(e.target.value)} placeholder="Use Short Code..." style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid #cbd5e1' }} />
                        </div>
                    </div>
